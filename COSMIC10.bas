...
1580 Missile%=FALSE : Score%=Score%+((3-((MissileY%-Y%)DIV3)DIV2)*20)
1590 ENDPROC
...
2360 REPEAT : PROC_Key_Test : PROC_Update_Invaders : REM IF NOT finish THEN PROC_Bombs (We won't drop bombs for now).
